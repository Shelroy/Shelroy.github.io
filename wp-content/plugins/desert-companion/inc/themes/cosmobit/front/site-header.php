...
$cosmobit_hdr_social 		= get_theme_mod( 'cosmobit_hdr_social',cosmobit_get_social_icon_default());
	...
	?>
	 ...
	 <div class="dt-container" >
				<div class="dt-row">
				<div class="dt-col-lg-12 dt-col-12 " id="top-bar">
				<p style ="text-align : center" > 
Embas of the Cooperative Republic of Guyana in the State of Qatar 
				...
				<div class="dt-row">
					<div class="dt-col-lg-6 dt-col-12">
						<div class="widget--left dt-text-lg-left">
							<?php if($cosmobit_hs_hdr_contact=='1'): ?>
								<aside class="widget widget_contact contact1">
									<div class="contact__list">
										<?php if(!empty($cosmobit_hdr_contact_icon)): ?>
											<i class="fa <?php echo esc_attr($cosmobit_hdr_contact_icon); ?>" aria-hidden="true"></i>
										<?php endif;?>
										
										<?php if(!empty($cosmobit_hdr_contact_title)): ?>
											<div class="contact__body">
												<h6 class="title"><a href="<?php echo esc_url($cosmobit_hdr_contact_link); ?>"><?php echo wp_kses_post($cosmobit_hdr_contact_title); ?></a></h6>
											</div>
										<?php endif;?>
									</div>
								</aside>
					...
					<div class="dt-col-lg-6 dt-col-12">
						<div class="widget--right dt-text-lg-right">
							...
							<?php if($cosmobit_hs_hdr_top_time=='1'): ?>
								<aside class="widget widget_contact contact4">
									<div class="contact__list">
										<?php if(!empty($cosmobit_hdr_top_time_icon)): ?>
											<i class="fa <?php echo esc_attr($cosmobit_hdr_top_time_icon); ?>" aria-hidden="true"></i>
										<?php endif;?>	
										<?php if(!empty($cosmobit_hdr_top_time_title)): ?>
											<div class="contact__body">
												<h6 class="title"><a href="<?php echo esc_url($cosmobit_hdr_top_time_link); ?>"><?php echo wp_kses_post($cosmobit_hdr_top_time_title); ?></a></h6>
											</div>
										<?php endif;?>
									</div>
								</aside>
